...
// 	 */
// 	public Queue<GOAPAct> plan(GameObject agent,
// 								  HashSet<GOAPAct> availableActions, 
// 	                              HashSet<KeyValuePair<string,object>> worldState, 
// 	                              HashSet<KeyValuePair<string,object>> goal) 
// 	{
// 		// reset the actions so we can start fresh with them
// 		foreach (GOAPAct a in availableActions) {
// 			a.doReset ();
// 		}

// 		// check what actions can run using their checkProceduralPrecondition
// 		HashSet<GOAPAct> usableActions = new HashSet<GOAPAct> ();
// 		foreach (GOAPAct a in availableActions) {
...
// 		Queue<GOAPAct> queue = new Queue<GOAPAct> ();
// 		foreach (GOAPAct a in result) {
// 			queue.Enqueue(a);
// 		}
...
// 	 * sequence.
// 	 */
// 	protected bool buildGraph (Node parent, List<Node> leaves, HashSet<GOAPAct> usableActions, HashSet<KeyValuePair<string, object>> goal)
// 	{
// 		bool foundOne = false;

// 		// go through each action available at this node and see if we can use it here
// 		foreach (GOAPAct action in usableActions) {
...
// 					HashSet<GOAPAct> subset = actionSubset(usableActions, action);
...
// 	 */
// 	protected HashSet<GOAPAct> actionSubset(HashSet<GOAPAct> actions, GOAPAct removeMe) {
// 		HashSet<GOAPAct> subset = new HashSet<GOAPAct> ();
...
// 		public Node(Node parent, float runningCost, HashSet<KeyValuePair<string,object>> state, GOAPAct action) {
// 			this.parent = parent;
